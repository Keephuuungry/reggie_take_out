...
//    }
    ...
    public R<List<DishDto>> list(Dish dish){
        ...
        // 优化：从redis中获取缓存数据，如果存在，直接返回，无需查询数据库；若不存在，则查询数据，并缓存到redis
        ...
        // 缓存中不存在，则查询数据库后将查询到的菜品数据缓存到Redis
